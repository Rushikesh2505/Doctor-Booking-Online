...
<body
	style="overflow: hidden; <%-- background-image: url('${pageContext.request.contextPath}/resources/images/norge-feat.jpg'); --%>">
	<div class="section">
			...
			<div class="row">
				<div class="col-sm-10 col-md-10 col-xs-10 col-8">
					<h3 id="displayText" style="display: none">
						<Strong><fmt:message key="message.uploadFile.text1" /></Strong>
					</h3>
				</div>
				<div id="ctnbtn" class="col-md-2 col-sm-2 col-xs-2 col-4"
					style="display: none; text-align: center;">
					<button onclick=" getFileDetails()" id="selectbutton"
						class="guide2 btn uploadbtn" data-toggle="tooltip"
						title="Continue to add requirements" disabled>
						<fmt:message key="message.uploadFile.text18" />
			...
			<div class="row" style="height: 100%;">
				...
				<div class="col-md-6 col-sm-6 col-xs-6 col-6 upload_file1_1">
					<div class="divinsideupload2">
						...
						<h2>A tool for Additive manufacturing/3D printing industry</h2>
						<hr>
						<p>You can generate an instant quotation for any CAD part
							based on the process and material specified. We evaluate the
							geometry of your 3D model and give you an instant price, design
							feedback, and delivery date.</p>
						<div>
							<button id="demobtntip" data-toggle="tooltip"
								title="Dont have CAD File! Try our demo for you."
								class="guide1 btn uploadbtn demobtn" onclick="uploadDemo()">Demo</button>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 col-sm-6 col-xs-6 col-6 upload_file1_2">
					<div class="divinsideupload1" id="divinsideupload1">
						<div class="div1">
							<h2>
								<fmt:message key="message.uploadFile.text2" />
							</h2>
						</div>
						<div class="div2">
							<form method="POST" id="login_form" enctype="multipart/form-data"
								class=" ">
								<label data-toggle="tooltip" title="Upload your part here!"
									for="fileList" data-multiple-caption="{count} files selected"
									class="box__file guide1 btn uploadbtn newuploadbtn"><fmt:message
										key="message.uploadFile.text3" /></label> <input type="file"
						...
						<div class="div3">
							<h4>
								<fmt:message key="message.uploadFile.text4" />
							</h4>
						</div>
					</div>
				</div>
		...
		<div class="row filerow">
			<div id="fileDiv" class="col-md-2 col-sm-2 col-xs-2 col-12">
				<div class="header col-xs-12 col-sm-12 col-md-12 col-12"
					...
					<fmt:message key="message.uploadFile.text11" />
			...
			<div class="col-md-8 col-sm-8 col-xs-8 col-12"
				...
				<div class="header col-sm-12 col-md-12 col-xs-12 col-12">
					<fmt:message key="message.uploadFile.text12" />
				...
				<ul class="button-group" style="position: absolute">
					...
					<li><button class="small button" id="transparent1"
							data-toggle="tooltip" title="X-Ray">
				...
				<div style="margin-left: 5%; margin-top: 1%; height: 50%;">
					<label class="fileDetails"><strong><fmt:message
						...
						class="fa fa-download"> <strong><fmt:message
									key="message.uploadFile.text16" /></strong>
					</i></a>
				</div>
			</div>
		</div>
