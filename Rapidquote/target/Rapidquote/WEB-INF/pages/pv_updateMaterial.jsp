	...
	<div class="col-md-6 col-sm-6 col-xs-6 col-6 dropdown">
		...
		<div id="categoryt1drp"
			...
			<c:forEach items="${category1}" var="mid" varStatus="status">
				...
				<a id="materialCat1Data${status.count}" class=" ${disabled} dropdown-item"
					href="#" materialId="${mid.materialId}"
					materialName="${mid.materialName}" description="${mid.description}"
					image="${mid.imageFile}" density="${mid.density}" rate="${mid.rate}"
	...
	<div class="col-md-6 col-sm-6 col-xs-6 col-6 dropdown">
		...
		<div id="categoryt2drp"
			...
			<c:choose>
				...
				<a id="materialCat2Data${status.count}" class=" ${disabled} dropdown-item"
					href="#" materialId="${mid.materialId}"
					materialName="${mid.materialName}" description="${mid.description}"
					image="${mid.imageFile}" density="${mid.density}" rate="${mid.rate}"
					categoryId="${mid.categoryId}" categoryName="${mid.categoryName}"
