...
<div class="ts3d-new-container">
	<div class="ts3d-top">
		...
		<%-- 	<a href="${pageContext.request.contextPath}/tips And Content" class="ts3d-bar-item ts3d-button ts3d-hide-small new-bar">
				<fmt:message key="message.uploadFile.text20" />
			</a> --%>
