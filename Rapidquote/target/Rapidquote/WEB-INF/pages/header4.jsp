	...
	<div class="ts3d-top">
		<div class="ts3d-bar ts3d-card ts3d-white" id="myNavbar">
			<a
				...
				<%-- <div>
				<div class="divimage1"><img class="responsive img-ts3d"
				src="${pageContext.request.contextPath}/resources/images/3dlogo.png" />
				</div>
				
				<div class="divimage2"><img class="responsive img-ts3d1"
				src="${pageContext.request.contextPath}/resources/images/rdlogo.png" />
				</div>
				</div> --%>
			</a> <a href="${pageContext.request.contextPath}/3dPrinting" class="ts3d-bar-item ts3d-button ts3d-hide-small new-bar"><fmt:message
					key="message.uploadFile.text5" /></a> <a
				href="${pageContext.request.contextPath}/howitworks" target="_blank"
			...
			<div
				...
				<ul id="listLang" style="width: 77.8594px;list-style: none !important;display: none!important;   margin: 0! important;padding: 0! important;background-color: #d8dee3;">
					<li><a onclick="updateLang()" href="?lang=fr"><fmt:message key="message.lang.fr" /></a></li>
					<li><a onclick="updateLang()" href="?lang=cn"><fmt:message key="message.lang.cn" /></a></li>
					<li><a onclick="updateLang()" href="?lang=de"><fmt:message key="message.lang.de" /></a></li>
					<li><a onclick="updateLang()" href="?lang=en"><fmt:message key="message.lang.en" /></a></li>
					<li><a onclick="updateLang()" href="?lang=sp"><fmt:message key="message.lang.sp" /></a></li>
					<li><a onclick="updateLang()" href="?lang=vi"><fmt:message key="message.lang.vi" /></a></li>
				</ul>
		...
		<div id="navDemo"
			...
			<a class="ts3d-bar-item ts3d-button" href="${pageContext.request.contextPath}/3dPrinting" onclick="toggleFunction()"><fmt:message
				...
				class="ts3d-bar-item ts3d-button" onclick="toggleFunction()"><fmt:message
					key="message.uploadFile.text6" /></a> <a href="#" style="display: none;"
